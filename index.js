...
// function for intermediate processing (middleware) -- for express read json (always top from middleware)
...
async function start() {
    try {
        await mongoose.connect('mongodb+srv://CoderFire:21212121@cluster0.glzcx.mongodb.net/womenUnderwear?retryWrites=true&w=majority', {
